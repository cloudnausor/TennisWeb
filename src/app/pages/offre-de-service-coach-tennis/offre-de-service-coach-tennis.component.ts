...
@Component({
  selector: "app-offre-de-service-coach-tennis",
  templateUrl: "./offre-de-service-coach-tennis.component.html",
  styleUrls: ["./offre-de-service-coach-tennis.component.scss"]
})
export class OffreDeServiceCoachTennisComponent extends AppComponent
  implements OnInit {
